...
class AlwaysBluffBot(BotBase):
    """Always bluffs with the maximum number of cards; never doubts."""

    def bluff_first_hand(self, p: TurnData) -> bool:    return True
    def maximize_first_hand(self, p: TurnData) -> bool: return True
    def should_doubt(self, p: TurnData) -> bool:        return False
    def bluff_regular(self, p: TurnData) -> bool:       return True
